...
export const LaptopFrame: React.FC<LaptopFrameProps> = ({
  ...
  const deployLog = [
    'LokiAI Deployment Agent v1.0',
    'Connecting to device via ADB...',
    'Device found: Your Device (serial: R58MA2)',
    'RAM: 5120MB | CPU: arm64-v8a | Android: 11',
                                ...
                                <div className="text-[8px] leading-relaxed text-neutral-400 space-y-1.5">
                                  ...
                                  {activeChapter === 'hero' ? (
                                    ...
                                    <div className="space-y-1 font-sans">
                                      <p>Found 3 models that fit Your Device (ARM64, 5GB RAM):</p>
